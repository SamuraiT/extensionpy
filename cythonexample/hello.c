/* Generated by Cython 0.19.1 on Fri Jun 13 23:54:25 2014 */
...
static char __pyx_k_4[] = "/Users/tatsuro/pyextbyc/cythonexample/hello.pyx";
...
static PyMethodDef __pyx_mdef_5hello_1hello = {__Pyx_NAMESTR("hello"), (PyCFunction)__pyx_pw_5hello_1hello, METH_NOARGS, __Pyx_DOCSTR(0)};
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("hello"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_2), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5hello_1hello, NULL, __pyx_n_s__hello); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
